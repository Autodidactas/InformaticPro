...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Videos.proximo'
        db.delete_column('sitio_videos', 'proximo')

        # Adding field 'Videos.portada'
        db.add_column('sitio_videos', 'portada',
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Videos.proximo'
        db.add_column('sitio_videos', 'proximo',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Videos.portada'
        db.delete_column('sitio_videos', 'portada')
