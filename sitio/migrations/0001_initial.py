...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('sitio_ponente', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('cuenta', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('sitio', ['Ponente'])
        ...
        db.create_table('sitio_videos', (
            ...
            ('usuario', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sitio.Ponente'])),
        ...
        db.create_table('sitio_talleres', (
            ...
            ('ponente', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sitio.Ponente'])),
        ))
        ...
        # Adding model 'ComunidadAmiga'
        db.create_table('sitio_comunidadamiga', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('fundador', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('descripcion', self.gf('django.db.models.fields.TextField')()),
            ('url_pag', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('logo', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
        ))
        db.send_create_signal('sitio', ['ComunidadAmiga'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'ComunidadAmiga'
        db.delete_table('sitio_comunidadamiga')
    ...
    models = {
        ...
        'sitio.comunidadamiga': {
            'Meta': {'object_name': 'ComunidadAmiga'},
            'descripcion': ('django.db.models.fields.TextField', [], {}),
            'fundador': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'logo': ('django.db.models.fields.files.ImageField', [], {'max_length': '100'}),
            'nombre': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'url_pag': ('django.db.models.fields.CharField', [], {'max_length': '200'})
        },
        'sitio.cursos': {
        ...
        'sitio.envivo': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ponente': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['sitio.Ponente']"}),
        ...
        'sitio.ponente': {
            ...
            'cuenta': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nombre': ('django.db.models.fields.CharField', [], {'max_length': '100'})
        },
        'sitio.redes': {
        ...
        'sitio.videos': {
            ...
            'usuario': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['sitio.Ponente']"})
        }
    }
