...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Videos.fecha'
        db.alter_column('sitio_videos', 'fecha', self.gf('django.db.models.fields.DateTimeField')())
    def backwards(self, orm):

        # Changing field 'Videos.fecha'
        db.alter_column('sitio_videos', 'fecha', self.gf('django.db.models.fields.DateField')())
    models = {
        'auth.group': {
